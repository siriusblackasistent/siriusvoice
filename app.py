'''
Голосовой ассистент "сириус блек"
...
model = vosk.Model(r"C:\Users\admin\Desktop\sirius\vosk-model-small-uk-v3-small")       #голосовую модель vosk нужно поместить в папку с файлами проекта
                                        #https://alphacephei.com/vosk/
                                        #https://alphacephei.com/vosk/models

device = sd.default.device    # <--- по умолчанию
#sd.default.device = 7, 1,                            #или -> sd.default.device = 1, 3, python -m sounddevice просмотр
